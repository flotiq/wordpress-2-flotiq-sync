<?php
/**
 * ContentTypeDefinitionSchemaFeaturedImageInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ContentTypeDefinitionSchemaFeaturedImageInner Class Doc Comment
 *
 * @category Class
 ...
 */
class ContentTypeDefinitionSchemaFeaturedImageInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ContentTypeDefinitionSchema_featuredImage_inner';
    ...
    {
        $this->container['data_url'] = $data['data_url'] ?? null;
        $this->container['type'] = $data['type'] ?? 'internal';
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['data_url'] === null) {
            $invalidProperties[] = "'data_url' can't be null";
        }
