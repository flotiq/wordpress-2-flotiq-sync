...
/**
 * MediaGetRemoved400Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MediaGetRemoved400Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Media_getRemoved_400_response';
    ...
    {
        $this->container['deleted_after'] = $data['deleted_after'] ?? null;
    }
     ...
     * @return string[]|null
     */
    public function getDeletedAfter()
    {
        return $this->container['deleted_after'];
    }

    /**
     * Sets deleted_after
     *
     * @param string[]|null $deleted_after deleted_after
     *
     * @return self
     */
    public function setDeletedAfter($deleted_after)
    {
        $this->container['deleted_after'] = $deleted_after;
