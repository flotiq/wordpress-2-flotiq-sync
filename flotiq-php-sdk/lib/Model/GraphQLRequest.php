...
/**
 * GraphQLRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GraphQLRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'graphQL_request';
     ...
     * Sets query
     *
     * @param string $query Graph QL query, for example: query{productsList{id,name}}
     *
     * @return self
     */
