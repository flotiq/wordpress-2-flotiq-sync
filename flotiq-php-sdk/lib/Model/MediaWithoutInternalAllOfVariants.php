<?php
/**
 * MediaWithoutInternalAllOfVariants
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * MediaWithoutInternalAllOfVariants Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MediaWithoutInternalAllOfVariants implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_mediaWithoutInternal_allOf_variants';
    ...
    protected static $openAPITypes = [
        'name' => 'string',
        'trim' => '\OpenAPI\Client\Model\MediaWithoutInternalAllOfTrim'
    ];
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling MediaWithoutInternalAllOfVariants., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[_a-zA-Z0-9]+$/", $name))) {
            throw new \InvalidArgumentException("invalid value for $name when calling MediaWithoutInternalAllOfVariants., must conform to the pattern /^[_a-zA-Z0-9]+$/.");
        }
     ...
     * Gets trim
     *
     * @return \OpenAPI\Client\Model\MediaWithoutInternalAllOfTrim|null
     */
     ...
     * Sets trim
     *
     * @param \OpenAPI\Client\Model\MediaWithoutInternalAllOfTrim|null $trim trim
     *
     * @return self
     */
