...
/**
 * WpPageWithoutRequired Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class WpPageWithoutRequired implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'wp_pageWithoutRequired';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['parent_page'] = $data['parent_page'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['parent_page']) && (count($this->container['parent_page']) < 0)) {
            $invalidProperties[] = "invalid value for 'parent_page', number of items must be greater than or equal to 0.";
        }
    ...
    public function setId($id)
    {
        ...
        if ((!preg_match("/^[a-zA-Z0-9-_.,:=!?#$%&(\\`\\’\\{\\}\" ]*$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling WpPageWithoutRequired., must conform to the pattern /^[a-zA-Z0-9-_.,:=!?#$%&(\\`\\’\\{\\}\" ]*$/.");
        }
    ...
    public function setSlug($slug)
    {
        ...
        if (!is_null($slug) && (mb_strlen($slug) < 1)) {
            throw new \InvalidArgumentException('invalid length for $slug when calling WpPageWithoutRequired., must be bigger than or equal to 1.');
        }
    ...
    public function setTitle($title)
    {
        ...
        if (!is_null($title) && (mb_strlen($title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $title when calling WpPageWithoutRequired., must be bigger than or equal to 1.');
        }
    ...
    public function setAuthor($author)
    {
        ...
        if (!is_null($author) && (count($author) < 0)) {
            throw new \InvalidArgumentException('invalid length for $author when calling WpPageWithoutRequired., number of items must be greater than or equal to 0.');
        }
     ...
     * Sets parent_page
     *
     * @param \OpenAPI\Client\Model\DataSource[]|null $parent_page 
     *
     * @return self
     */
    public function setParentPage($parent_page)
    {
        ...
        if (!is_null($parent_page) && (count($parent_page) < 0)) {
            throw new \InvalidArgumentException('invalid length for $parent_page when calling WpPageWithoutRequired., number of items must be greater than or equal to 0.');
        }
    ...
    public function setFeaturedMedia($featured_media)
    {
        ...
        if (!is_null($featured_media) && (count($featured_media) < 0)) {
            throw new \InvalidArgumentException('invalid length for $featured_media when calling WpPageWithoutRequired., number of items must be greater than or equal to 0.');
        }
