 ...
 */
class WpCategory implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'wp_category';
    ...
    public function setId($id)
    {
        ...
        if ((!preg_match("/^[a-zA-Z0-9-_.,:=!?#$%&(\\`\\’\\{\\}\" ]*$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling WpCategory., must conform to the pattern /^[a-zA-Z0-9-_.,:=!?#$%&(\\`\\’\\{\\}\" ]*$/.");
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling WpCategory., must be bigger than or equal to 1.');
        }
    ...
    public function setSlug($slug)
    {
        ...
        if ((mb_strlen($slug) < 1)) {
            throw new \InvalidArgumentException('invalid length for $slug when calling WpCategory., must be bigger than or equal to 1.');
        }
    ...
    public function setParentCategory($parent_category)
    {
        ...
        if (!is_null($parent_category) && (count($parent_category) < 0)) {
            throw new \InvalidArgumentException('invalid length for $parent_category when calling WpCategory., number of items must be greater than or equal to 0.');
        }
