<?php
/**
 * WpCategoryWithoutInternalAllOf
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * WpCategoryWithoutInternalAllOf Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class WpCategoryWithoutInternalAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'wp_categoryWithoutInternal_allOf';
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling WpCategoryWithoutInternalAllOf., must be bigger than or equal to 1.');
        }
    ...
    public function setSlug($slug)
    {
        ...
        if (!is_null($slug) && (mb_strlen($slug) < 1)) {
            throw new \InvalidArgumentException('invalid length for $slug when calling WpCategoryWithoutInternalAllOf., must be bigger than or equal to 1.');
        }
    ...
    public function setParentCategory($parent_category)
    {
        ...
        if (!is_null($parent_category) && (count($parent_category) < 0)) {
            throw new \InvalidArgumentException('invalid length for $parent_category when calling WpCategoryWithoutInternalAllOf., number of items must be greater than or equal to 0.');
        }
