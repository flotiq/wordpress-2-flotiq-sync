...
/**
 * WpCategoryWithoutRequired Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class WpCategoryWithoutRequired implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'wp_categoryWithoutRequired';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['parent_category']) && (count($this->container['parent_category']) < 0)) {
            $invalidProperties[] = "invalid value for 'parent_category', number of items must be greater than or equal to 0.";
        }
    ...
    public function setId($id)
    {
        ...
        if ((!preg_match("/^[a-zA-Z0-9-_.,:=!?#$%&(\\`\\’\\{\\}\" ]*$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling WpCategoryWithoutRequired., must conform to the pattern /^[a-zA-Z0-9-_.,:=!?#$%&(\\`\\’\\{\\}\" ]*$/.");
        }
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling WpCategoryWithoutRequired., must be bigger than or equal to 1.');
        }
    ...
    public function setSlug($slug)
    {
        ...
        if (!is_null($slug) && (mb_strlen($slug) < 1)) {
            throw new \InvalidArgumentException('invalid length for $slug when calling WpCategoryWithoutRequired., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param \OpenAPI\Client\Model\DataSource[]|null $parent_category 
     *
     * @return self
     */
    public function setParentCategory($parent_category)
    {
        ...
        if (!is_null($parent_category) && (count($parent_category) < 0)) {
            throw new \InvalidArgumentException('invalid length for $parent_category when calling WpCategoryWithoutRequired., number of items must be greater than or equal to 0.');
        }
