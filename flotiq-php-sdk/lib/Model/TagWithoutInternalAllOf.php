...
/**
 * TagWithoutInternalAllOf Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TagWithoutInternalAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_tagWithoutInternal_allOf';
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling TagWithoutInternalAllOf., must be bigger than or equal to 1.');
        }
