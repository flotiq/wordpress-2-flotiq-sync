...
/**
 * WpPostWithoutInternal Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class WpPostWithoutInternal implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'wp_postWithoutInternal';
    ...
    public function setId($id)
    {
        ...
        if ((!preg_match("/^[a-zA-Z0-9-_.,:=!?#$%&(\\`\\’\\{\\}\" ]*$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling WpPostWithoutInternal., must conform to the pattern /^[a-zA-Z0-9-_.,:=!?#$%&(\\`\\’\\{\\}\" ]*$/.");
        }
    ...
    public function setSlug($slug)
    {
        ...
        if ((mb_strlen($slug) < 1)) {
            throw new \InvalidArgumentException('invalid length for $slug when calling WpPostWithoutInternal., must be bigger than or equal to 1.');
        }
    ...
    public function setTags($tags)
    {
        ...
        if (!is_null($tags) && (count($tags) < 0)) {
            throw new \InvalidArgumentException('invalid length for $tags when calling WpPostWithoutInternal., number of items must be greater than or equal to 0.');
        }
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $title when calling WpPostWithoutInternal., must be bigger than or equal to 1.');
        }
    ...
    public function setAuthor($author)
    {
        ...
        if (!is_null($author) && (count($author) < 0)) {
            throw new \InvalidArgumentException('invalid length for $author when calling WpPostWithoutInternal., number of items must be greater than or equal to 0.');
        }
    ...
    public function setStatus($status)
    {
        ...
        if ((mb_strlen($status) < 1)) {
            throw new \InvalidArgumentException('invalid length for $status when calling WpPostWithoutInternal., must be bigger than or equal to 1.');
        }
    ...
    public function setCategories($categories)
    {
        ...
        if (!is_null($categories) && (count($categories) < 0)) {
            throw new \InvalidArgumentException('invalid length for $categories when calling WpPostWithoutInternal., number of items must be greater than or equal to 0.');
        }
    ...
    public function setFeaturedMedia($featured_media)
    {
        ...
        if (!is_null($featured_media) && (count($featured_media) < 0)) {
            throw new \InvalidArgumentException('invalid length for $featured_media when calling WpPostWithoutInternal., number of items must be greater than or equal to 0.');
        }
