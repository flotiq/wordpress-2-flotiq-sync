 ...
 */
class WpPageWithoutInternal implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setId($id)
    {
        ...
        if ((!preg_match("/^[a-zA-Z0-9-_.,:=!?#$%&(\\`\\’\\{\\}\" ]*$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling WpPageWithoutInternal., must conform to the pattern /^[a-zA-Z0-9-_.,:=!?#$%&(\\`\\’\\{\\}\" ]*$/.");
        }
    ...
    public function setAuthor($author)
    {
        ...
        if (!is_null($author) && (count($author) < 0)) {
            throw new \InvalidArgumentException('invalid length for $author when calling WpPageWithoutInternal., number of items must be greater than or equal to 0.');
        }
    ...
    public function setParentPage($parent_page)
    {
        ...
        if (!is_null($parent_page) && (count($parent_page) < 0)) {
            throw new \InvalidArgumentException('invalid length for $parent_page when calling WpPageWithoutInternal., number of items must be greater than or equal to 0.');
        }
    ...
    public function setFeaturedMedia($featured_media)
    {
        ...
        if (!is_null($featured_media) && (count($featured_media) < 0)) {
            throw new \InvalidArgumentException('invalid length for $featured_media when calling WpPageWithoutInternal., number of items must be greater than or equal to 0.');
        }
