 ...
 */
class WpPost implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setId($id)
    {
        ...
        if ((!preg_match("/^[a-zA-Z0-9-_.,:=!?#$%&(\\`\\’\\{\\}\" ]*$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling WpPost., must conform to the pattern /^[a-zA-Z0-9-_.,:=!?#$%&(\\`\\’\\{\\}\" ]*$/.");
        }
    ...
    public function setTags($tags)
    {
        ...
        if (!is_null($tags) && (count($tags) < 0)) {
            throw new \InvalidArgumentException('invalid length for $tags when calling WpPost., number of items must be greater than or equal to 0.');
        }
    ...
    public function setAuthor($author)
    {
        ...
        if (!is_null($author) && (count($author) < 0)) {
            throw new \InvalidArgumentException('invalid length for $author when calling WpPost., number of items must be greater than or equal to 0.');
        }
    ...
    public function setCategories($categories)
    {
        ...
        if (!is_null($categories) && (count($categories) < 0)) {
            throw new \InvalidArgumentException('invalid length for $categories when calling WpPost., number of items must be greater than or equal to 0.');
        }
    ...
    public function setFeaturedMedia($featured_media)
    {
        ...
        if (!is_null($featured_media) && (count($featured_media) < 0)) {
            throw new \InvalidArgumentException('invalid length for $featured_media when calling WpPost., number of items must be greater than or equal to 0.');
        }
