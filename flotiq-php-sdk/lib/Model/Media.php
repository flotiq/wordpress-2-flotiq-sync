...
class Media implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_media';
    ...
    public function setId($id)
    {
        ...
        if ((!preg_match("/^[a-zA-Z0-9-_.,:=!?#$%&(\\`\\’\\{\\}\" ]*$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling Media., must conform to the pattern /^[a-zA-Z0-9-_.,:=!?#$%&(\\`\\’\\{\\}\" ]*$/.");
        }
    ...
    public function setUrl($url)
    {
        ...
        if ((mb_strlen($url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $url when calling Media., must be bigger than or equal to 1.');
        }
    ...
    public function setTags($tags)
    {
        ...
        if (!is_null($tags) && (count($tags) < 0)) {
            throw new \InvalidArgumentException('invalid length for $tags when calling Media., number of items must be greater than or equal to 0.');
        }
    ...
    public function setType($type)
    {
        ...
        if ((mb_strlen($type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $type when calling Media., must be bigger than or equal to 1.');
        }
    ...
    public function setSource($source)
    {
        ...
        if ((mb_strlen($source) < 1)) {
            throw new \InvalidArgumentException('invalid length for $source when calling Media., must be bigger than or equal to 1.');
        }
    ...
    public function setFileName($file_name)
    {
        ...
        if ((mb_strlen($file_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $file_name when calling Media., must be bigger than or equal to 1.');
        }
    ...
    public function setMimeType($mime_type)
    {
        ...
        if ((mb_strlen($mime_type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $mime_type when calling Media., must be bigger than or equal to 1.');
        }
    ...
    public function setVariants($variants)
    {
        ...
        if (!is_null($variants) && (count($variants) < 0)) {
            throw new \InvalidArgumentException('invalid length for $variants when calling Media., number of items must be greater than or equal to 0.');
        }
    ...
    public function setExtension($extension)
    {
        ...
        if ((mb_strlen($extension) < 1)) {
            throw new \InvalidArgumentException('invalid length for $extension when calling Media., must be bigger than or equal to 1.');
        }
