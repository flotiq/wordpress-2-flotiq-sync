...
/**
 * MediaWithoutInternalAllOf Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MediaWithoutInternalAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_mediaWithoutInternal_allOf';
    ...
    public function setUrl($url)
    {
        ...
        if (!is_null($url) && (mb_strlen($url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $url when calling MediaWithoutInternalAllOf., must be bigger than or equal to 1.');
        }
    ...
    public function setTags($tags)
    {
        ...
        if (!is_null($tags) && (count($tags) < 0)) {
            throw new \InvalidArgumentException('invalid length for $tags when calling MediaWithoutInternalAllOf., number of items must be greater than or equal to 0.');
        }
    ...
    public function setType($type)
    {
        ...
        if (!is_null($type) && (mb_strlen($type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $type when calling MediaWithoutInternalAllOf., must be bigger than or equal to 1.');
        }
    ...
    public function setSource($source)
    {
        ...
        if (!is_null($source) && (mb_strlen($source) < 1)) {
            throw new \InvalidArgumentException('invalid length for $source when calling MediaWithoutInternalAllOf., must be bigger than or equal to 1.');
        }
    ...
    public function setFileName($file_name)
    {
        ...
        if (!is_null($file_name) && (mb_strlen($file_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $file_name when calling MediaWithoutInternalAllOf., must be bigger than or equal to 1.');
        }
    ...
    public function setMimeType($mime_type)
    {
        ...
        if (!is_null($mime_type) && (mb_strlen($mime_type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $mime_type when calling MediaWithoutInternalAllOf., must be bigger than or equal to 1.');
        }
    ...
    public function setVariants($variants)
    {
        ...
        if (!is_null($variants) && (count($variants) < 0)) {
            throw new \InvalidArgumentException('invalid length for $variants when calling MediaWithoutInternalAllOf., number of items must be greater than or equal to 0.');
        }
    ...
    public function setExtension($extension)
    {
        ...
        if (!is_null($extension) && (mb_strlen($extension) < 1)) {
            throw new \InvalidArgumentException('invalid length for $extension when calling MediaWithoutInternalAllOf., must be bigger than or equal to 1.');
        }
