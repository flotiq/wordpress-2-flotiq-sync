...
/**
 * WpPageWithoutInternalAllOf Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class WpPageWithoutInternalAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'wp_pageWithoutInternal_allOf';
    ...
    public function setSlug($slug)
    {
        ...
        if (!is_null($slug) && (mb_strlen($slug) < 1)) {
            throw new \InvalidArgumentException('invalid length for $slug when calling WpPageWithoutInternalAllOf., must be bigger than or equal to 1.');
        }
    ...
    public function setTitle($title)
    {
        ...
        if (!is_null($title) && (mb_strlen($title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $title when calling WpPageWithoutInternalAllOf., must be bigger than or equal to 1.');
        }
    ...
    public function setAuthor($author)
    {
        ...
        if (!is_null($author) && (count($author) < 0)) {
            throw new \InvalidArgumentException('invalid length for $author when calling WpPageWithoutInternalAllOf., number of items must be greater than or equal to 0.');
        }
    ...
    public function setParentPage($parent_page)
    {
        ...
        if (!is_null($parent_page) && (count($parent_page) < 0)) {
            throw new \InvalidArgumentException('invalid length for $parent_page when calling WpPageWithoutInternalAllOf., number of items must be greater than or equal to 0.');
        }
    ...
    public function setFeaturedMedia($featured_media)
    {
        ...
        if (!is_null($featured_media) && (count($featured_media) < 0)) {
            throw new \InvalidArgumentException('invalid length for $featured_media when calling WpPageWithoutInternalAllOf., number of items must be greater than or equal to 0.');
        }
