...
/**
 * TagWithoutInternal Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TagWithoutInternal implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_tagWithoutInternal';
    ...
    public function setId($id)
    {
        ...
        if ((!preg_match("/^[a-zA-Z0-9-_.,:=!?#$%&(\\`\\’\\{\\}\" ]*$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling TagWithoutInternal., must conform to the pattern /^[a-zA-Z0-9-_.,:=!?#$%&(\\`\\’\\{\\}\" ]*$/.");
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling TagWithoutInternal., must be bigger than or equal to 1.');
        }
