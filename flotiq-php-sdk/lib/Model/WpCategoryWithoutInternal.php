 ...
 */
class WpCategoryWithoutInternal implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setId($id)
    {
        ...
        if ((!preg_match("/^[a-zA-Z0-9-_.,:=!?#$%&(\\`\\’\\{\\}\" ]*$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling WpCategoryWithoutInternal., must conform to the pattern /^[a-zA-Z0-9-_.,:=!?#$%&(\\`\\’\\{\\}\" ]*$/.");
        }
    ...
    public function setParentCategory($parent_category)
    {
        ...
        if (!is_null($parent_category) && (count($parent_category) < 0)) {
            throw new \InvalidArgumentException('invalid length for $parent_category when calling WpCategoryWithoutInternal., number of items must be greater than or equal to 0.');
        }
